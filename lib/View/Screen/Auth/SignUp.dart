    ...
    child:GetBuilder<SignUpControllerImp>(builder: (controller)=>
      ...
      child: Form(
        ...
        child: ListView(children: [
          ...
          CustomButtomAuth(text: "18".tr, onPressed: () {
            controller.signUp().then((value) => ScaffoldMessenger.of(context).showSnackBar( SnackBar(
              duration:const Duration(seconds: 2),
              content: Center(child: Text("29".tr,style:const TextStyle(fontSize: 18,
